...
<div class="all">
  <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch"
    data-aos="fade-up" data-aos-delay="200" style="opacity: 1;width: 430px;margin: auto;">
    <form action='login' method='post' name ="form" style="width: 400px">
      <div class="total">
        <div class="content">
          <h3>LOGIN</h3>
      ...
      <div class="totalUnderForm">
        <div class="cheackBoxArea">
        <input type='checkbox' name='saveEmail' class="context-text"
          style="margin-bottom: 10px; text-algin: center;"> 이메일 저장해두기
        </div>
        <div class="buttonArea">
        <input type ="button" id="btn" value="로그인" onClick="formCheck()">
        </div>
      </div>
      <div class="apiButtonArea">
        <fb:login-button scope="public_profile,email" onlogin="checkLoginState();">
        </fb:login-button>
      </div>
      <div class="etc">
        <a href="../user/findinfoform"  class="search" style="margin: 0px 15px;color: #7a6960;" >비밀번호 찾기</a>
          <a href='../user/form' style="margin: 0px 15px;color: #7a6960;">회원가입</a>
      </div>
    </form>
  </div>
  </div>
